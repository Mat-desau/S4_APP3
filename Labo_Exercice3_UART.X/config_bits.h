/* ************************************************************************** */
/* Note YBL: Ceci est le fichier config_bits_YBL.h renommé en        */
/* config_bits.h afin de l'inclure dans les projets.                 */
/* Ce fichier, lorsque généré par MPLAB, comme ça a été le cas pour  */
/* le présent fichier, est généré comme config_bits.c (donc un       */
...
#pragma config FPLLMUL = MUL_24 // PLL Multiplier (24x Multiplier) YBL: corrigé, il était indiqué 20x ici, mais c'est vraiment 24x
