...
# 29 "lcd.c" 2
# 1 "/Applications/microchip/xc32/v2.50/pic32mx/include/string.h" 1 3
# 14 "/Applications/microchip/xc32/v2.50/pic32mx/include/string.h" 3
...
unsigned char LCD_ReadByte()
{
 ...
 LATDbits.LATD4 = 1;
    delay1us(1);
   bData = (unsigned char)(PORTE & (unsigned int)0xFF);
 LATDbits.LATD4 = 0;
 return bData;
}
# 230 "lcd.c"
...
void LCD_DisplaySet(unsigned char bDisplaySetOptions)
{
 LCD_WriteCommand(0x0C | bDisplaySetOptions);
}
# 383 "lcd.c"
void LCD_DisplayClear()
{
...
void LCD_DisplayShift(unsigned char fRight)
{
 unsigned char bCmd = 0x18 | (fRight ? 0x04: 0);
 LCD_WriteCommand(bCmd);
}
# 443 "lcd.c"
void LCD_CursorShift(unsigned char fRight)
{
 unsigned char bCmd = 0x10 | (fRight ? 0x04: 0);
 LCD_WriteCommand(bCmd);
}
# 476 "lcd.c"
...
void int2char(int value, char * text, int nbDigit, int erase) {
    ...
    text[nbDigit-i-1] = (char) (value % div) + '0';
    value = value / 10;
...
void LCD_CLEAR() {
    char vide[] = "                 ";
    LCD_WriteStringAtPos(vide, 0, 0);
    LCD_WriteStringAtPos(vide, 1, 0);
}
